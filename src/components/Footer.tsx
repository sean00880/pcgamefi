...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#1A1C1E] text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-gray-800 pb-12">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-[#7FF252] text-black flex items-center justify-center font-bold text-lg rounded">PC</div>
              <span className="font-bold text-2xl display-font">GAMEFI</span>
            </Link>
            ...
            <div className="flex gap-4">
              {SOCIAL_LINKS.map(link => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-400 hover:text-[#7FF252] transition-colors"
                >
                  {link.platform}
                </a>
              ))}
          ...
          <div>
            <h4 className="font-bold mb-4 uppercase tracking-wider text-sm">Ecosystem</h4>
